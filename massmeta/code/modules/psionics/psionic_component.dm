...
/datum/component/psionics/Initialize(latent = TRUE, psi_levels = 1)
	if(!isliving(parent))
...
/datum/component/psionics/proc/assign_path(datum/source, /datum/psionic_path/new_path)
	psi_path = new_path
	psi_path.on_assign(src)
